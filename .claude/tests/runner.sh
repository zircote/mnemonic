...
# Generated by auto-harness plugin for mnemonic
#
# Commands:
...
#   report [--format md|html|json]            Generate report
...
# Configuration - all paths within .claude/
...
if format_type == 'json':
    ...
    print(f"| ⏭️ Skipped | {len(skipped)} | {pct_skip} |")
