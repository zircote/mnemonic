...
rg "database" ~/.claude/mnemonic/*/decisions/ --glob "*.memory.md"

# Learnings about testing
rg "test" ~/.claude/mnemonic/*/learnings/ --glob "*.memory.md"
...
rg -l "^type: episodic" ~/.claude/mnemonic/*/blockers/ --glob "*.memory.md"

# Procedural memories in patterns (workflows)
rg -l "^type: procedural" ~/.claude/mnemonic/*/patterns/ --glob "*.memory.md"
```
...
rg "pattern" ~/.claude/mnemonic/*/decisions/ --glob "*.memory.md" &
rg "pattern" ~/.claude/mnemonic/*/learnings/ --glob "*.memory.md" &
wait
```
...
for f in $(rg -l "confidence: 0\.9" ~/.claude/mnemonic/*/security/ --glob "*.memory.md" 2>/dev/null); do
    grep "^title:" "$f"
done
```
...
| Goal | Command |
|------|---------|
| All decisions | `rg "^namespace: decisions" ~/.claude/mnemonic/ -l` |
